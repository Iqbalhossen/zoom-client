                    ...
                    <div className="gi-app-store mb-[30px] flex flex-row max-[1199px]:flex-col max-[991px]:flex-row max-[320px]:flex-col">
                      <a href="#" className="app-img">
                        <img
                          ...
                          className="adroid max-w-[140px] max-[1399px]:max-w-[120px]  mb-[15px] mr-[15px]"
                          alt="apple"
                        />
                      </a>
                      <a href="#" className="app-img">
                        <img
                          ...
                          className="apple max-w-[140px] max-[1399px]:max-w-[120px] mb-[15px]"
                          alt="apple"
                        />
                      </a>
                    </div>
                      ...
                      <div className="gi-footer-links gi-footer-dropdown">
                        <ul className="align-itegi-center flex flex-wrap">
                          <li className="gi-footer-link pr-[5px]">
                            <a
                              href="#"
                              className="h-[30px] w-[30px] bg-[#4b5966] capitalize flex items-center justify-center text-[15px]"
                            >
                              <i
